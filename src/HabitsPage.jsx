...
const PRESET_HABITS = [
  ...
  { key: 'holy_consecration', icon: '🕯️', name: '晨间奉献', desc: '每天开始前把身体、时间、思想、工作重新献给神', color: '#5ac8fa' },
  { key: 'holy_presence', icon: '⏱️', name: '神同在暂停', desc: '每天至少一次暂停30秒，观察、悔改、归回', color: '#34c759' },
  { key: 'holy_speech', icon: '💬', name: '言语训练', desc: '复盘一句话，操练诚实、温柔、少论断', color: '#f472b6' },
  { key: 'holy_charity', icon: '🤲', name: '爱心行动', desc: '每天帮助、鼓励、饶恕或服事一个具体的人', color: '#fbbf24' },
  { key: 'holy_examen', icon: '🌙', name: '晚间圣洁省察', desc: '睡前回顾今天哪里荣耀神、哪里需要悔改和更新', color: '#a78bfa' },
]
