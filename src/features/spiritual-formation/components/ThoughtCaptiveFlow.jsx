  ...
  return (
    <section className="sf-section">
      ...
      <div className="sf-step-list">
        <label><b>1. Catch</b><span>What thought, image, desire, or accusation is moving through your mind?</span><textarea value={form.catchThought} onChange={(e) => update('catchThought', e.target.value)} /></label>
        ...
        <label><b>3. Expose</b><span>What lie is this thought asking you to believe?</span><textarea value={form.exposedLie} placeholder={pattern.coreLie} onChange={(e) => update('exposedLie', e.target.value)} /></label>
        <label><b>4. Replace</b><span>What truth from God answers this lie?</span><textarea value={form.replacementTruth} placeholder={pattern.gospelTruth} onChange={(e) => update('replacementTruth', e.target.value)} /></label>
        <label><b>5. Obey</b><span>What is one small act of obedience you can take now?</span><textarea value={form.obedienceAction} placeholder={pattern.putOnActions[0]} onChange={(e) => update('obedienceAction', e.target.value)} /></label>
      </div>
