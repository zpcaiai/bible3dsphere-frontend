...
const HYMNS = [
  {
    id: 'amazing-grace',
    file: t("075p2-奇異恩典-AMAZING-GRACE.mp3"),
    title: t("奇异恩典"),
    en: 'Amazing Grace',
    author: t("词 John Newton, 1779"),
    note: t("全球流传最广的圣诗。前贩奴船长约翰·牛顿悔改后所写，真实表达从罪恶中被拯救的感恩。"),
    lyrics: [
      t("奇异恩典 何等甘甜\n我罪已得赦免\n前我失丧 今被寻回\n瞎眼今得看见"),
      t("如此恩典 使我敬畏\n使我心得安慰\n初信之时 即蒙恩惠\n真是何等宝贵"),
      t("许多危险 试炼网罗\n我已安然经过\n靠主恩典 安全不怕\n更引导我归家"),
  ...
  {
    id: 'it-is-well',
    file: t("359p2-我心靈得安寧-IT-IS-WELL-WITH-MY-SOUL.mp3"),
    title: t("我心灵得安宁"),
    en: 'It Is Well with My Soul',
    author: t("词 Horatio Spafford, 1873"),
    note: t("芝加哥律师斯帕福德在家产毁于大火、四个女儿于海难全部丧生后，行经出事海域写下此歌。充满安慰的力量。"),
    lyrics: [
      t("有时享平安 如江河平又稳\n有时忧伤来似浪滚\n不论何环境 主已教导我说\n我心灵得安宁 得安宁"),
      t("我心灵 得安宁\n我心灵得安宁 得安宁"),
      t("撒但虽搅扰 试炼虽来侵\n主已应许必看顾我\n基督既看顾 何必再忧愁\n主流出宝血 为救我"),
  ...
  },
  {
    ...
    file: t("002p-祢真偉大-HOW-GREAT-THOU-ART.mp3"),
    title: t("你真伟大"),
    en: 'How Great Thou Art',
    author: t("词 Carl Boberg, 1885"),
    note: t("气势磅礴，常用于崇拜赞美的高潮，颂赞上帝创造宇宙万物的伟大。"),
    lyrics: [
      t("主啊我神 我每逢举目观看\n你手所造 一切奇妙大工\n看见星宿 又听到隆隆雷声\n你的大能 遍满了宇宙中"),
      t("我灵歌唱 赞美救主我神\n你真伟大 何等伟大\n我灵歌唱 赞美救主我神\n你真伟大 何等伟大"),
      t("当我想到 神竟愿差祂儿子\n降世舍命 我几乎不领会\n主在十架 甘愿背我的重担\n流血舍身 为要赦免我罪"),
  ...
  },
  {
    ...
    author: t("词 Reginald Heber, 1826"),
    note: t("极其庄严，是主日崇拜（尤其传统教会）宣召或开会时最常唱的传统圣诗之一。"),
    lyrics: [
      t("圣哉 圣哉 圣哉\n全能大主宰\n清晨我众歌颂\n同声赞美主名"),
      t("圣哉 圣哉 圣哉\n慈悲与全能\n三位同荣一体\n万古永远长存"),
      t("圣哉 圣哉 圣哉\n众圣都崇敬\n放下黄金冠冕\n环绕在主宝座"),
  ...
  },
  {
    ...
    file: t("050b-有福的確據-BLESSED-ASSURANCE-JESUS-IS-MINE.mp3"),
    title: t("有福确知"),
    en: 'Blessed Assurance',
    author: t("词 Fanny Crosby, 1873"),
    note: t("盲眼诗人克罗斯比最著名的作品，全球主日聚会最常唱的宣信诗歌之一。旋律欢快坚定，唱出对救恩的把握与喜乐。"),
    lyrics: [
      t("有福确知 耶稣属我\n何等荣耀 向我显明\n我是后嗣 已蒙救赎\n圣灵重生 宝血洗净"),
      t("这是我信息 我的诗歌\n赞美我救主 昼夜唱和\n这是我信息 我的诗歌\n赞美我救主 昼夜唱和"),
      t("完全的顺服 完全的喜乐\n荣耀异象现我心中\n天使临格 带下慈爱\n慈声细语 由天传颂"),
  ...
  },
  {
    ...
    author: t("词 Fanny Crosby, 1868"),
    note: t("谱曲家弹出一段旋律问克罗斯比听到什么，盲眼的她立刻说「我听到了安全在耶稣手中」，几分钟内写下歌词。常于追思礼拜或患难中唱起，带来极大安慰。"),
    lyrics: [
      t("安全在耶稣手中\n安全在主怀里\n有主慈爱的膀臂\n时常环绕保护"),
      t("安全在耶稣手中\n安全在主怀里\n听啊救恩的声音\n响彻在天庭里"),
      t("在主怀中安息\n免受试探苦害\n脱离一切的忧愁\n远离罪恶网罗"),
  ...
  {
    id: 'joy-to-the-world',
    file: t("117o-普世歡騰-Joy-To-The-World.mp3"),
    title: t("普世欢腾"),
    en: 'Joy to the World',
    author: t("词 Isaac Watts, 1719"),
    note: t("全球最著名的圣诞赞美诗，欢腾迎接救主降临。"),
    lyrics: [
      t("普世欢腾 救主下降\n大地接她君王\n惟愿众心 预备地方\n诸天万物歌唱\n诸天万物歌唱\n诸天 诸天万物歌唱"),
      t("普世欢腾 主治万方\n民众都当歌唱\n沃野洪涛 山石平原\n响应歌声嘹亮\n响应歌声嘹亮\n响应 响应歌声嘹亮"),
      t("主以真理 恩治万方\n要使万邦证明\n上主公义 无限荣光\n主爱奇妙莫名\n主爱奇妙莫名\n主爱 主爱奇妙莫名"),
  ...
  },
  {
    ...
    author: t("词 Isaac Watts, 1707"),
    note: t("被许多神学家评为「英语世界中最伟大的圣诗」。受难节、圣餐礼拜时全场齐唱，往往令人动容。"),
    lyrics: [
      t("每逢思念奇妙十架\n荣耀之主在上悬挂\n从前所夸 今觉空虚\n甘心舍弃 当作粪土"),
      t("愿主禁我别有所夸\n惟夸我主舍身十架\n前所珍爱 虚荣浮华\n为主之故 全都撇下"),
      t("看主圣首 圣手圣足\n慈爱忧愁 融成一处\n如此奇恩 如此宏爱\n何等荣冠 何等苦楚"),
  ...
  {
    id: 'mighty-fortress',
    file: t("081b-堅固保障-A-MIGHTY-FORTRESS-IS-OUR-GOD.mp3"),
    title: t("坚固保障"),
    en: 'A Mighty Fortress Is Our God',
    author: t("词 Martin Luther, 1529"),
    note: t("宗教改革时期的「战歌」。旋律充满力量，唱起来如军队前行，震撼人心，是新教教会的基石之作。"),
    lyrics: [
      t("上主是我坚固保障\n庄严稳固永坚强\n上主使我安稳前航\n助我乘风破巨浪"),
      t("惟靠我们自己力量\n我们斗争必失败\n但有一位适时兴起\n是主耶稣亲拣选"),
      t("我神乃是大能堡垒\n抵御世仇敌侵犯\n世仇仍在向我夸胜\n奸狡兼有大权能"),
  ...
  },
  {
    ...
    file: t("342-主我願像祢-O-TO-BE-LIKE-THEE.mp3"),
    title: t("主我愿像祢"),
    en: 'O To Be Like Thee',
    author: t("词 Thomas O. Chisholm, 1897"),
    note: t("诗人渴望生命被塑造、完全像基督：柔和谦卑、圣洁有怜悯。"),
    lyrics: [
      t("荣耀的救主 我深愿像祢\n这是我祷告 我的盼望\n我甘愿舍弃 世上的财宝\n披戴主基督 完美形像"),
      t("（副歌）\n主我愿像祢 主我愿像祢\n荣耀的救主 像祢纯洁\n愿祢的甘甜 愿祢的丰满\n愿祢的圣形 深印我灵"),
      t("主我愿像祢 有怜悯心肠\n温柔和宽恕 慈爱善良\n帮助孤苦者 鼓励灰心者\n领人归基督 寻找亡羊"),
  ...
  },
  {
    ...
    author: t("词 Fanny Crosby, 1875"),
    note: t("盲眼女诗人芬妮·克罗斯比的感恩之作：救主一路引导，我还要求什么？"),
    lyrics: [
      t("一路我蒙救主引导\n陈腐事何须计较\n难道我还疑祂爱心\n毕生既由祂领导\n神圣安慰 属天生活\n凭信我可安然享受\n我深知道 凡事临到\n主必为我安排妥"),
      t("一路我蒙救主引导\n鼓励我走每一步\n赐我灵粮使我饱足\n帮助我胜过试炼\n我灵虽然疲倦干渴\n举步艰难几乎跌倒\n看哪眼前有一磐石\n喜乐活泉向我涌流"),
      t("一路我蒙救主引导\n主爱何等丰富甘甜\n祂曾应许在父家里\n为我备有安息地点\n当我灵魂披上荣体\n飞进天府快乐无边\n千秋万岁我仍传扬\n耶稣一路引导我"),
  ...
  },
  {
    ...
    file: t("奇异恩典-合唱（四声部）.mp3"),
    title: t("奇异恩典（四声部合唱）"),
    en: 'Amazing Grace (SATB)',
    author: t("词 John Newton, 1779"),
    note: t("奇异恩典的四声部合唱版本，声部交织更显恩典的丰盛。"),
    lyrics: [
      t("奇异恩典 何等甘甜\n我罪已得赦免\n前我失丧 今被寻回\n瞎眼今得看见"),
      t("如此恩典 使我敬畏\n使我心得安慰\n初信之时 即蒙恩惠\n真是何等宝贵"),
      t("许多危险 试炼网罗\n我已安然经过\n靠主恩典 安全不怕\n更引导我归家"),
...
function ScorePlaceholder({ title }) {
  ...
  return (
    <svg className="hymn-score-svg" viewBox="0 0 320 110" preserveAspectRatio="xMidYMid meet" role="img" aria-label={`${title} 曲谱占位`}>
      ...
      <text x="160" y="98" textAnchor="middle" className="hymn-score-svg-hint">{t("曲谱占位 · 放入 public/hymns 后自动替换")}</text>
    </svg>
  )
}
...
export default function HymnPlayer() {
  ...
  return (
    <div className="hymn-page">
      {/* 诗歌选择 */}
      <div className="hymn-chips" role="tablist" aria-label={t("圣诗选择")}>
        {HYMNS.map((h, i) => (
          <button
            key={h.id}
            role="tab"
          ...
          <button
            ...
            onClick={() => {
              ...
              if (navigator.share) { navigator.share(data).catch(() => {}) }
                ...
                if (window.showToast) window.showToast(t("分享链接已复制"), 'success')
              }
            }}>{t("↗ 分享")}</button>
        </div>
      ...
      {/* 播放器 */}
      <div className="hymn-player" role="group" aria-label={t("播放控制")} onKeyDown={onPlayerKey}>
        <audio
          ref={audioRef}
          ...
          preload="metadata"
        />
        <button className="hymn-nav-btn" onClick={goPrev} aria-label={t("上一首")}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M7 6h2v12H7zm3.5 6l8.5 6V6z" /></svg>
        </button>
        <button className="hymn-play-btn" onClick={togglePlay} disabled={audioErr} aria-label={playing ? t("暂停") : t("播放")}>
          {playing ? (
        ...
        <button className="hymn-nav-btn" onClick={goNext} aria-label={t("下一首")}>
      ...
      {audioErr && (
        <div className="hymn-audio-hint">{t("🎵 音频待添加：把文件放到")} <code>public/hymns/{hymn.id}.mp3</code></div>
      )}
      ...
      {/* 完整歌词 */}
      <div className="hymn-lyrics-label">{t("完整歌词")}</div>
