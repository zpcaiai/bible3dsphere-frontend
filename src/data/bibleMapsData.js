...
const tribes = {
  id: 'tribes',
  title: '十二支派分地',
  subtitle: '应许之地的产业分配 · 13疆界 + 利未48城 + 6逃城（书13–21 · 民35）',
  era: '约主前 1400 · 约书亚分地',
  badge: '★★★★★',
  ...
  regions: [
    {
      id: 'judah', label: '犹大', name_en: 'Judah', color: '#fbbf24',
      center: [35.05, 31.42],
      polygon: [[34.78, 31.05], [34.82, 31.72], [35.1, 31.78], [35.45, 31.72], [35.42, 31.3], [35.2, 31.0], [34.95, 30.95]],
      scriptureRef: '书15',
      note: '南到寻的旷野、加低斯巴尼亚与埃及小河；东界死海；北沿便雅悯（耶路撒冷以南）；西临大海。地业最大，后分出西缅、但。',
      events: [
        { title: '疆界', ref: '书15', summary: '南到寻的旷野、加低斯巴尼亚与埃及小河；东界死海；北沿便雅悯（耶路撒冷以南）；西临大海。地业最大，后分出西缅、但。' },
        { title: '主要城邑', summary: '希伯仑、伯利恒、伯示麦、底璧、立拿、拉吉' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 100%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '希伯仑★、立拿、雅提珥、以实提莫、何仑、底璧、淤他、伯示麦（祭司·亚伦子孙之城）' },
      ],
    },
    {
      id: 'simeon', label: '西缅', name_en: 'Simeon', color: '#f59e0b',
      center: [34.8, 31.1],
      polygon: [[34.55, 30.92], [34.62, 31.3], [35.05, 31.28], [35.1, 31.0], [34.78, 30.88]],
      scriptureRef: '书19:1-9',
      note: '地业在犹大境内南方（别是巴、洗革拉一带的尼革旷野），无独立连续疆界，取自犹大过大的份。',
      events: [
        { title: '疆界', ref: '书19:1-9', summary: '地业在犹大境内南方（别是巴、洗革拉一带的尼革旷野），无独立连续疆界，取自犹大过大的份。' },
        { title: '主要城邑', summary: '别是巴、洗革拉、何珥玛' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 25%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '亚因（亚珊，祭司城）' },
      ],
    },
    {
      id: 'benjamin', label: '便雅悯', name_en: 'Benjamin', color: '#fb7185',
      center: [35.26, 31.84],
      polygon: [[35.05, 31.78], [35.1, 31.95], [35.48, 31.92], [35.45, 31.78], [35.25, 31.74]],
      scriptureRef: '书18:11-28',
      note: '夹在以法莲（北）与犹大（南）之间的狭小山地；东抵约旦河与耶利哥，含耶路撒冷、基遍等要邑。',
      events: [
        { title: '疆界', ref: '书18:11-28', summary: '夹在以法莲（北）与犹大（南）之间的狭小山地；东抵约旦河与耶利哥，含耶路撒冷、基遍等要邑。' },
        { title: '主要城邑', summary: '耶利哥、基遍、耶路撒冷（边界）、伯特利' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 18%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '基遍、迦巴、亚拿突、亚勒们（皆祭司城）' },
      ],
    },
    {
      id: 'dan', label: '但（原地）', name_en: 'Dan', color: '#f472b6',
      center: [34.9, 31.92],
      polygon: [[34.72, 31.8], [34.78, 32.05], [35.05, 32.05], [35.05, 31.82], [34.88, 31.78]],
      scriptureRef: '书19:40-48',
      note: '以法莲之南、犹大之西的沿海平原与亚雅仑谷（约帕一带）。地业狭小，部分但人后北迁夺取拉亿，改名为但。',
      events: [
        { title: '疆界', ref: '书19:40-48', summary: '以法莲之南、犹大之西的沿海平原与亚雅仑谷（约帕一带）。地业狭小，部分但人后北迁夺取拉亿，改名为但。' },
        { title: '主要城邑', summary: '约帕、亚雅仑、伊基伦、拉亿（北迁）' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 14%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '伊利提基、基比顿、亚雅仑、迦特临门' },
      ],
    },
    {
      id: 'ephraim', label: '以法莲', name_en: 'Ephraim', color: '#34d399',
      center: [35.22, 32.06],
      polygon: [[34.95, 31.95], [35.0, 32.2], [35.45, 32.2], [35.42, 31.95], [35.18, 31.9]],
      scriptureRef: '书16',
      note: '约瑟次子半支派，居中央山地；北接玛拿西，南邻便雅悯，西向基色平原，东抵约旦河。会幕长设于示罗。',
      events: [
        { title: '疆界', ref: '书16', summary: '约瑟次子半支派，居中央山地；北接玛拿西，南邻便雅悯，西向基色平原，东抵约旦河。会幕长设于示罗。' },
        { title: '主要城邑', summary: '示剑、示罗、基色、伯特利（边界）' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 45%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '示剑★、基色、基伯先、伯和仑' },
      ],
    },
    {
      id: 'manasseh-west', label: '玛拿西（西）', name_en: 'Manasseh (W)', color: '#10b981',
      center: [35.22, 32.36],
      polygon: [[34.95, 32.18], [35.05, 32.58], [35.45, 32.55], [35.5, 32.22], [35.2, 32.12]],
      scriptureRef: '书17:1-13',
      note: '约瑟长子半支派，居以法莲之北；横跨撒玛利亚山地直抵沿海多珥，含他纳、米吉多、伯善等险要城邑。',
      events: [
        { title: '疆界', ref: '书17:1-13', summary: '约瑟长子半支派，居以法莲之北；横跨撒玛利亚山地直抵沿海多珥，含他纳、米吉多、伯善等险要城邑。' },
        { title: '主要城邑', summary: '他纳、米吉多、多珥、伯善' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 55%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '他纳、迦特临门（《代上》作以伯莲/比连）' },
      ],
    },
    {
      id: 'issachar', label: '以萨迦', name_en: 'Issachar', color: '#22d3ee',
      center: [35.46, 32.52],
      polygon: [[35.28, 32.5], [35.45, 32.64], [35.62, 32.58], [35.58, 32.42], [35.38, 32.42]],
      scriptureRef: '书19:17-23',
      note: '他泊山到约旦河之间的耶斯列（米吉多）平原东部；北接拿弗他利、西布伦，东抵约旦河，南邻玛拿西。',
      events: [
        { title: '疆界', ref: '书19:17-23', summary: '他泊山到约旦河之间的耶斯列（米吉多）平原东部；北接拿弗他利、西布伦，东抵约旦河，南邻玛拿西。' },
        { title: '主要城邑', summary: '耶斯列、基善、隐干宁、书念' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 35%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '基善、大比拉、耶末、隐干宁' },
      ],
    },
    {
      id: 'zebulun', label: '西布伦', name_en: 'Zebulun', color: '#38bdf8',
      center: [35.27, 32.74],
      polygon: [[35.08, 32.62], [35.15, 32.92], [35.42, 32.88], [35.45, 32.66], [35.25, 32.6]],
      scriptureRef: '书19:10-16',
      note: '加利利下游，介于亚设（西）与拿弗他利（东）之间；预言“必住在海口、停船的方便港口”。',
      events: [
        { title: '疆界', ref: '书19:10-16', summary: '加利利下游，介于亚设（西）与拿弗他利（东）之间；预言“必住在海口、停船的方便港口”。' },
        { title: '主要城邑', summary: '约念、拿哈拉、伯利恒（西布伦的）' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 25%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '约念、加他、丁拿、拿哈拉' },
      ],
    },
    {
      id: 'asher', label: '亚设', name_en: 'Asher', color: '#818cf8',
      center: [35.12, 33.0],
      polygon: [[34.95, 33.05], [35.3, 33.25], [35.35, 32.95], [35.15, 32.82], [34.98, 32.88]],
      scriptureRef: '书19:24-31',
      note: '西北沿海，自迦密山北上直抵西顿、推罗一带腓尼基边界；东邻西布伦与拿弗他利，西临大海。',
      events: [
        { title: '疆界', ref: '书19:24-31', summary: '西北沿海，自迦密山北上直抵西顿、推罗一带腓尼基边界；东邻西布伦与拿弗他利，西临大海。' },
        { title: '主要城邑', summary: '亚柯、利合、黑甲、押顿' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 45%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '米沙勒、押顿、黑甲、利合' },
      ],
    },
    {
      id: 'naphtali', label: '拿弗他利', name_en: 'Naphtali', color: '#a78bfa',
      center: [35.5, 33.0],
      polygon: [[35.35, 32.92], [35.4, 33.3], [35.62, 33.2], [35.6, 32.78], [35.42, 32.8]],
      scriptureRef: '书19:32-39',
      note: '加利利东北高地；西界西布伦、亚设，东沿加利利海与上约旦河，北抵黎巴嫩谷。',
      events: [
        { title: '疆界', ref: '书19:32-39', summary: '加利利东北高地；西界西布伦、亚设，东沿加利利海与上约旦河，北抵黎巴嫩谷。' },
        { title: '主要城邑', summary: '夏琐、基低斯、基尼烈' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 50%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '基低斯★、哈末多珥、加珥但' },
      ],
    },
    {
      id: 'reuben', label: '流便', name_en: 'Reuben', color: '#c084fc',
      center: [35.78, 31.42],
      polygon: [[35.55, 31.0], [35.58, 31.85], [35.98, 31.82], [35.95, 31.05], [35.72, 30.95]],
      scriptureRef: '书13:15-23',
      note: '约旦河东最南：自亚嫩河（南界）北至希实本平原；东接旷野，西临死海。雅各长子，地宜牧畜。',
      events: [
        { title: '疆界', ref: '书13:15-23', summary: '约旦河东最南：自亚嫩河（南界）北至希实本平原；东接旷野，西临死海。雅各长子，地宜牧畜。' },
        { title: '主要城邑', summary: '底本、米底巴、亚罗珥、希实本（界）' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 50%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '比悉★、雅杂、基底莫、米法押' },
      ],
    },
    {
      id: 'gad', label: '迦得', name_en: 'Gad', color: '#e879f9',
      center: [35.84, 32.12],
      polygon: [[35.6, 31.85], [35.62, 32.42], [36.1, 32.4], [36.05, 31.88], [35.82, 31.82]],
      scriptureRef: '书13:24-28',
      note: '约旦河东中部基列：南起希实本，北至玛哈念、雅博河谷；东接亚扪，西临约旦河谷。',
      events: [
        { title: '疆界', ref: '书13:24-28', summary: '约旦河东中部基列：南起希实本，北至玛哈念、雅博河谷；东接亚扪，西临约旦河谷。' },
        { title: '主要城邑', summary: '拉末（基列）、玛哈念、雅谢、疏割' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 55%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '拉末（基列）★、玛哈念、希实本、雅谢' },
      ],
    },
    {
      id: 'manasseh-east', label: '玛拿西（东·巴珊）', name_en: 'Manasseh (E)', color: '#2dd4bf',
      center: [36.0, 32.85],
      polygon: [[35.65, 32.42], [35.7, 33.28], [36.3, 33.25], [36.28, 32.45], [35.9, 32.38]],
      scriptureRef: '书13:29-31',
      note: '约旦河东巴珊全地与基列北半：自雅博河北上至黑门山、撒迦；玛吉、睚珥子孙所得。',
      events: [
        { title: '疆界', ref: '书13:29-31', summary: '约旦河东巴珊全地与基列北半：自雅博河北上至黑门山、撒迦；玛吉、睚珥子孙所得。' },
        { title: '主要城邑', summary: '哥兰、亚斯他录、以得来、撒迦' },
        { title: '相对区域大小（估算）', summary: '约为最大支派犹大的 70%（按疆界描述估算，非精确面积）' },
        { title: '境内利未城', ref: '书21', summary: '哥兰★、比施提拉（亚斯他录）' },
      ],
    },
  ],
  boundaries: [
    { id: 'jordan-river', label: '约旦河', color: '#7dd3fc', path: [[35.62, 33.20], [35.58, 32.78], [35.56, 32.30], [35.50, 31.85], [35.46, 31.45], [35.45, 31.05]], dashed: true },
  ],
  layers: [
    { id: 'refuge', label: '逃城 ★（兼利未城）', color: '#ef4444', route: false, points: [
      { id: 'ref-hebron', name_zh: '希伯仑', name_en: 'Hebron', lng: 35.1, lat: 31.53, marker: 'star', confidence: 'approximate', scriptureRef: '书21；民35', note: '犹大山地 · 祭司（亚伦子孙）之城 · 河西南逃城', events: [] },
      { id: 'ref-shechem', name_zh: '示剑', name_en: 'Shechem', lng: 35.28, lat: 32.21, marker: 'star', confidence: 'approximate', scriptureRef: '书21；民35', note: '以法莲山地 · 哥辖宗族 · 河西中逃城', events: [] },
      { id: 'ref-kedesh', name_zh: '基低斯', name_en: 'Kedesh', lng: 35.53, lat: 33.11, marker: 'star', confidence: 'approximate', scriptureRef: '书21；民35', note: '拿弗他利·加利利 · 革顺宗族 · 河西北逃城', events: [] },
      { id: 'ref-bezer', name_zh: '比悉', name_en: 'Bezer', lng: 35.72, lat: 31.75, marker: 'star', confidence: 'approximate', scriptureRef: '书21；民35', note: '流便·旷野平原 · 米拉利宗族 · 河东南逃城', events: [] },
      { id: 'ref-ramoth-gilead', name_zh: '拉末（基列）', name_en: 'Ramoth-Gilead', lng: 35.86, lat: 32.49, marker: 'star', confidence: 'approximate', scriptureRef: '书21；民35', note: '迦得·基列 · 米拉利宗族 · 河东中逃城', events: [] },
      { id: 'ref-golan', name_zh: '哥兰', name_en: 'Golan', lng: 35.98, lat: 32.97, marker: 'star', confidence: 'approximate', scriptureRef: '书21；民35', note: '玛拿西东·巴珊 · 革顺宗族 · 河东北逃城', events: [] },
    ] },
    { id: 'levite', label: '利未城 ◆', color: '#3b82f6', route: false, points: [
      { id: 'lev-libnah', name_zh: '立拿', name_en: 'Libnah', lng: 34.87, lat: 31.62, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '犹大 · 祭司城', events: [] },
      { id: 'lev-jattir', name_zh: '雅提珥', name_en: 'Jattir', lng: 35.07, lat: 31.3, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '犹大 · 祭司城', events: [] },
      { id: 'lev-eshtemoa', name_zh: '以实提莫', name_en: 'Eshtemoa', lng: 35.07, lat: 31.4, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '犹大 · 祭司城', events: [] },
      { id: 'lev-holon', name_zh: '何仑', name_en: 'Holon', lng: 35.0, lat: 31.46, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '犹大 · 祭司城', events: [] },
      { id: 'lev-debir', name_zh: '底璧', name_en: 'Debir', lng: 34.99, lat: 31.42, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '犹大 · 祭司城', events: [] },
      { id: 'lev-juttah', name_zh: '淤他', name_en: 'Juttah', lng: 35.1, lat: 31.45, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '犹大 · 祭司城', events: [] },
      { id: 'lev-beth-shemesh', name_zh: '伯示麦', name_en: 'Beth-shemesh', lng: 34.98, lat: 31.77, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '犹大 · 祭司城', events: [] },
      { id: 'lev-ain-ashan', name_zh: '亚因（亚珊）', name_en: 'Ain-Ashan', lng: 34.85, lat: 31.3, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '西缅 · 祭司城', events: [] },
      { id: 'lev-gibeon', name_zh: '基遍', name_en: 'Gibeon', lng: 35.18, lat: 31.85, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '便雅悯 · 祭司城', events: [] },
      { id: 'lev-geba', name_zh: '迦巴', name_en: 'Geba', lng: 35.26, lat: 31.86, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '便雅悯 · 祭司城', events: [] },
      { id: 'lev-anathoth', name_zh: '亚拿突', name_en: 'Anathoth', lng: 35.26, lat: 31.81, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '便雅悯 · 祭司城', events: [] },
      { id: 'lev-almon', name_zh: '亚勒们', name_en: 'Almon', lng: 35.28, lat: 31.83, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '便雅悯 · 祭司城', events: [] },
      { id: 'lev-gezer', name_zh: '基色', name_en: 'Gezer', lng: 34.92, lat: 31.86, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '以法莲 · 哥辖宗族', events: [] },
      { id: 'lev-kibzaim', name_zh: '基伯先', name_en: 'Kibzaim', lng: 35.2, lat: 32.1, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '以法莲 · 哥辖宗族', events: [] },
      { id: 'lev-beth-horon', name_zh: '伯和仑', name_en: 'Beth-horon', lng: 35.1, lat: 31.88, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '以法莲 · 哥辖宗族', events: [] },
      { id: 'lev-eltekeh', name_zh: '伊利提基', name_en: 'Eltekeh', lng: 34.8, lat: 31.79, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '但 · 哥辖宗族', events: [] },
      { id: 'lev-gibbethon', name_zh: '基比顿', name_en: 'Gibbethon', lng: 34.83, lat: 31.81, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '但 · 哥辖宗族', events: [] },
      { id: 'lev-aijalon', name_zh: '亚雅仑', name_en: 'Aijalon', lng: 35.02, lat: 31.85, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '但 · 哥辖宗族', events: [] },
      { id: 'lev-gath-rimmon', name_zh: '迦特临门', name_en: 'Gath-rimmon', lng: 34.88, lat: 32.06, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '但 · 哥辖宗族', events: [] },
      { id: 'lev-taanach', name_zh: '他纳', name_en: 'Taanach', lng: 35.22, lat: 32.51, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '玛拿西西 · 哥辖宗族', events: [] },
      { id: 'lev-gath-rimmon-ibleam', name_zh: '迦特临门（以伯莲）', name_en: 'Gath-rimmon-Ibleam', lng: 35.3, lat: 32.43, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '玛拿西西 · 哥辖宗族（《代上》作以伯莲/比连）', events: [] },
      { id: 'lev-beeshterah', name_zh: '比施提拉（亚斯他录）', name_en: 'Beeshterah', lng: 36.0, lat: 32.8, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '玛拿西东 · 革顺宗族', events: [] },
      { id: 'lev-kishion', name_zh: '基善', name_en: 'Kishion', lng: 35.45, lat: 32.6, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '以萨迦 · 革顺宗族', events: [] },
      { id: 'lev-daberath', name_zh: '大比拉', name_en: 'Daberath', lng: 35.4, lat: 32.68, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '以萨迦 · 革顺宗族', events: [] },
      { id: 'lev-jarmuth', name_zh: '耶末', name_en: 'Jarmuth', lng: 35.5, lat: 32.55, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '以萨迦 · 革顺宗族', events: [] },
      { id: 'lev-en-gannim', name_zh: '隐干宁', name_en: 'En-gannim', lng: 35.3, lat: 32.47, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '以萨迦 · 革顺宗族', events: [] },
      { id: 'lev-mishal', name_zh: '米沙勒', name_en: 'Mishal', lng: 35.15, lat: 32.85, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '亚设 · 革顺宗族', events: [] },
      { id: 'lev-abdon', name_zh: '押顿', name_en: 'Abdon', lng: 35.1, lat: 33.05, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '亚设 · 革顺宗族', events: [] },
      { id: 'lev-helkath', name_zh: '黑甲', name_en: 'Helkath', lng: 35.12, lat: 32.83, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '亚设 · 革顺宗族', events: [] },
      { id: 'lev-rehob', name_zh: '利合', name_en: 'Rehob', lng: 35.12, lat: 33.0, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '亚设 · 革顺宗族', events: [] },
      { id: 'lev-hammoth-dor', name_zh: '哈末多珥', name_en: 'Hammoth-dor', lng: 35.57, lat: 32.78, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '拿弗他利 · 革顺宗族', events: [] },
      { id: 'lev-kartan', name_zh: '加珥但', name_en: 'Kartan', lng: 35.48, lat: 33.02, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '拿弗他利 · 革顺宗族', events: [] },
      { id: 'lev-jokneam', name_zh: '约念', name_en: 'Jokneam', lng: 35.11, lat: 32.66, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '西布伦 · 米拉利宗族', events: [] },
      { id: 'lev-kartah', name_zh: '加他', name_en: 'Kartah', lng: 35.2, lat: 32.72, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '西布伦 · 米拉利宗族', events: [] },
      { id: 'lev-dimnah', name_zh: '丁拿', name_en: 'Dimnah', lng: 35.28, lat: 32.78, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '西布伦 · 米拉利宗族', events: [] },
      { id: 'lev-nahalal', name_zh: '拿哈拉', name_en: 'Nahalal', lng: 35.2, lat: 32.7, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '西布伦 · 米拉利宗族', events: [] },
      { id: 'lev-jahaz', name_zh: '雅杂', name_en: 'Jahaz', lng: 35.8, lat: 31.6, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '流便 · 米拉利宗族', events: [] },
      { id: 'lev-kedemoth', name_zh: '基底莫', name_en: 'Kedemoth', lng: 35.85, lat: 31.55, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '流便 · 米拉利宗族', events: [] },
      { id: 'lev-mephaath', name_zh: '米法押', name_en: 'Mephaath', lng: 35.9, lat: 31.78, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '流便 · 米拉利宗族', events: [] },
      { id: 'lev-mahanaim', name_zh: '玛哈念', name_en: 'Mahanaim', lng: 35.65, lat: 32.2, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '迦得 · 米拉利宗族', events: [] },
      { id: 'lev-heshbon', name_zh: '希实本', name_en: 'Heshbon', lng: 35.81, lat: 31.8, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '迦得 · 米拉利宗族', events: [] },
      { id: 'lev-jazer', name_zh: '雅谢', name_en: 'Jazer', lng: 35.78, lat: 31.95, marker: 'diamond', confidence: 'approximate', scriptureRef: '书21；民35', note: '迦得 · 米拉利宗族', events: [] },
    ] },
  ],
}
