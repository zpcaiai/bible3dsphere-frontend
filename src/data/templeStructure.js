...
export const TEMPLE_PARTS = {
  ...
  'altar-network': { name: '铜祭坛铜网', ref: '王下25:17；王上7:17', dims: '柱顶与祭坛周围有铜链网子与石榴装饰', desc: '铜网与石榴环绕，象征护卫与生命的丰盛；也可指祭坛上的铜格，使火炭与祭物得通风。' },
  ...
  laver:     { name: '洗濯盆', ref: '王上7:38-39；出30:18-21', dims: '十个带轮的铜座，每座承一铜盆，供祭司洗手洗脚', desc: '祭司近前供职前必须洁净，预表事奉圣洁之神者需先自洁。' },
  outerCourt:{ name: '外院（百姓/外邦人院）', ref: '王上8:41-43；结40:17-20', dims: '环绕内院的大院，供以色列百姓与外邦寻求者敬拜', desc: '所罗门为殿中的外邦人祷告（王上8:41-43），预表福音要传到万国。' },
  eastGate:  { name: '东门', ref: '结43:1-4；王上8:65', dims: '圣殿朝东的主门，面向橄榄山', desc: '耶和华的荣耀从东边而来，东门是敬拜者进入、朝见神的正路。' },
